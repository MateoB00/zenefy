        ...
        const fetchUserData = async () => {
            ...
            if (category && city) {
                ...
                services.map(service => {
                    if (service['category_service'].name === 'Coiffure') service.image = '/images/accueil/categorie_coiffure.png'
                    if (service['category_service'].name === 'Manucure') service.image = '/images/accueil/categorie_manucure.png'
                    if (service['category_service'].name === 'Massage') service.image = '/images/accueil/categorie_massage.png'
                    if (service['category_service'].name === 'Musculation') service.image = '/images/accueil/categorie_musculation.png'
                    if (service['category_service'].name === 'Spa') service.image = '/images/accueil/categorie_spa.png'
                    if (service['category_service'].name === 'Yoga') service.image = '/images/accueil/categorie_yoga.png'
                })
